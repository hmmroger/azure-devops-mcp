...
function configureWorkItemTools(server: McpServer, tokenProvider: () => Promise<AccessToken>, connectionProvider: () => Promise<WebApi>, userAgentProvider: () => string, disabledTools: Set<string>) {
  if (!disabledTools.has(WORKITEM_TOOLS.list_backlogs)) {
    server.tool(
  ...
  if (!disabledTools.has(WORKITEM_TOOLS.list_backlog_work_items)) {
    server.tool(
  ...
  if (!disabledTools.has(WORKITEM_TOOLS.my_work_items)) {
    server.tool(
  ...
  if (!disabledTools.has(WORKITEM_TOOLS.get_work_items_batch_by_ids)) {
    server.tool(
  ...
  if (!disabledTools.has(WORKITEM_TOOLS.get_work_item)) {
    server.tool(
  ...
  if (!disabledTools.has(WORKITEM_TOOLS.list_work_item_comments)) {
    server.tool(
  ...
  if (!disabledTools.has(WORKITEM_TOOLS.add_work_item_comment)) {
    server.tool(
  ...
  if (!disabledTools.has(WORKITEM_TOOLS.add_child_work_items)) {
    server.tool(
  ...
  if (!disabledTools.has(WORKITEM_TOOLS.link_work_item_to_pull_request)) {
    server.tool(
  ...
  if (!disabledTools.has(WORKITEM_TOOLS.get_work_items_for_iteration)) {
    server.tool(
  ...
  if (!disabledTools.has(WORKITEM_TOOLS.update_work_item)) {
    server.tool(
  ...
  if (!disabledTools.has(WORKITEM_TOOLS.get_work_item_type)) {
    server.tool(
  ...
  if (!disabledTools.has(WORKITEM_TOOLS.create_work_item)) {
    server.tool(
  ...
  if (!disabledTools.has(WORKITEM_TOOLS.get_query)) {
    server.tool(
  ...
  if (!disabledTools.has(WORKITEM_TOOLS.get_query_results_by_id)) {
    server.tool(
  ...
  if (!disabledTools.has(WORKITEM_TOOLS.update_work_items_batch)) {
    server.tool(
  ...
  if (!disabledTools.has(WORKITEM_TOOLS.work_items_link)) {
    server.tool(
  ...
  if (!disabledTools.has(WORKITEM_TOOLS.close_and_link_workitem_duplicates)) {
    server.tool(
